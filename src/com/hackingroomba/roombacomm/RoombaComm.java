...
public abstract class RoombaComm
{
    ...
    /**
     * Connect to a host on a port port
     * @return true on successful connect, false otherwise
     */
    public abstract  boolean connect(String server, int port);
    /**
...
//		}
    ...
    public boolean control() {
        logmsg("control");
        mode = MODE_SAFE;
        boolean controlling = send( CONTROL );
        ...
        controlling = controlling & setLEDs(false, false, false, false, false, true, 128, 255);
        return controlling;
    }
    /**  Send SAFE command  */
    public void safe() { 
...
//        send( CLEAN );
     ...
     */
    public boolean  setLEDs( boolean status_green, boolean status_red,
